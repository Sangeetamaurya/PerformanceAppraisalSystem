...
export default function HRAnalyticsPage() {
  ...
  return (
    <div>
      ...
      {/* Sentiment — only averageSentimentScore and count are available from backend */}
      {sentiment && (
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card>
          <h2 className="font-semibold text-gray-900 mb-5">Department Performance</h2>
                ...
                <div key={dept.department}>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-gray-400">{dept.count} appraisals</span>
        ...
        {/* Top Performers — populated Appraisal docs */}
        <Card>
          <h2 className="font-semibold text-gray-900 mb-5">Top Performers</h2>
      ...
      {/* Bias Cases — populated Appraisal docs */}
      <Card>
        <div className="flex items-center gap-2 mb-5">
          <h2 className="font-semibold text-gray-900">Bias Detection Cases</h2>
          {biasCases.length > 0 && (
              ...
              <tbody className="divide-y divide-gray-50">
                {biasCases.map((bc) => (
                  <tr key={bc._id} className="hover:bg-red-50/40 transition-colors">
                    ...
                    <td className="px-3 py-2.5">
                      <span className={`font-medium ${getSentimentColor(bc.sentimentCategory)}`}>{bc.sentimentCategory}</span>
                    </td>
                    <td className="px-3 py-2.5">
                      <span className={`font-bold ${getScoreColor(bc.finalScore)}`}>{bc.finalScore.toFixed(1)}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
