      ...
      <PageHeader
        ...
        action={
          <Link href="/manager/appraisal">
            <Button size="sm" className="sm:text-sm">+ Submit Appraisal</Button>
          </Link>
        }
      />
        ...
        <>
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
            ...
            <StatCard
              ...
              icon={<svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>}
            />
            <StatCard
              label="Avg. Attendance"
              value={`${avgAttendance}%`}
              accentClass="bg-violet-50 text-violet-600"
              icon={<svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>}
            />
          </div>
          ...
          <Card>
            ...
            <div className="space-y-2">
              {employees.slice(0, 6).map((emp) => (
                <div key={emp._id} className="flex items-center gap-3 py-2 border-b border-gray-50 last:border-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 truncate">{emp.department} · {emp.employeeId}</p>
                  </div>
                  ...
                  <Link href="/manager/appraisal">
                    <Button variant="ghost" size="sm" className="shrink-0 text-xs">Appraise</Button>
                  </Link>
                </div>
              ))}
            </div>
